...
%token IF ELSE FOR ADDOP ASSIGNOP COMMA CONST_FLOAT CONST_INT DECOP ID INCOP INT LCURL LOGICOP LPAREN LTHIRD MULOP NOT PRINTLN RCURL RELOP RETURN RPAREN RTHIRD SEMICOLON VOID WHILE FLOAT DO BREAK CONTINUE CHAR DOUBLE SWITCH CASE DEFAULT
...
statement : var_declaration
	  ...
	  | IF LPAREN expression RPAREN statement ELSE statement
	  {
			...
			$$ = new symbol_info("if("+$3->getname()+")\n"+$5->getname()+"else"+$7->getname(),"stmnt");
